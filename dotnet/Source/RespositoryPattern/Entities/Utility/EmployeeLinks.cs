...
namespace Entities.Utility
{
    public class EmployeeLinks
    {
        ...
        private LinkResponse ReturnLinkedEmployees(IEnumerable<EmployeeDto> employeesDto, string fields, Guid companyId, HttpContext httpContext, List<Entity> shapedEmployees)
        {
            ...
            {
                var employeeLinks = CreateLinkForEmployee(httpContext, companyId, employeeDtoList[index].Id, fields);
                shapedEmployees[index].Add("Link", employeeLinks);
            }

            var employeeCollection = new LinkCollectionWrapper<Entity>(shapedEmployees);
            var linkedEmployees = CreateLinkForEmployee(httpContext, employeeCollection);
        ...
        private LinkCollectionWrapper<Entity> CreateLinkForEmployee(HttpContext httpContext, LinkCollectionWrapper<Entity> employeesWrapper)
        {
